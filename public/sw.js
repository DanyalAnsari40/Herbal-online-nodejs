...
self.addEventListener('push', (event) => {
  ...
  event.waitUntil(
    self.registration.showNotification('Elite Admin Panel', options)
  );
});
...
async function handleBackgroundSync() {
  try {
    ...
    // For example, sync offline orders, update cache, etc.
    console.log('[SW] Handling background sync tasks');
    
    // You can add specific sync logic for your admin panel here
    // such as syncing offline orders, updating product data, etc.
